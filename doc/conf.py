...
copyright = (
    "2020, Allen Goodman, Claire McQuin, Shantanu Singh, Gregory Way, Frances Hubis"
)
...
latex_documents = [
    (
        master_doc,
        "cytominer_database.tex",
        "cytominer\\_database Documentation",
...
man_pages = [
    (master_doc, "cytominer_database", "cytominer_database Documentation", [author], 1)
]
